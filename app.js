...
// Seleccionar la etiqueta div del código QR
const codigoQRDiv = document.querySelector('.codigo-qr');

// Generar el código QR con el contenido deseado
const qrCode = new QRCode(codigoQRDiv, {
  text: 'https://wa.link/bxohdz', // Reemplaza con tu URL de LinkedIn
  width: 200,
  height: 200
});
